...
function SINGLE_CHAR_SCRIPT.StatusEffectsTutorial(owner, ownerChar, context, args) --Supposed to play when the player hits a trap.
...
--SINGLE_CHAR_SCRIPTs are misery inducing dungeon scripts that don't want to fire unless you did something related to getting punched.