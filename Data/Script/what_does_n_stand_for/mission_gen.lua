...
MISSION_GEN.DUNGEON_LIST["drenchedbluff"] = { [0] = "F" }
...
MISSION_GEN.POKEMON = {
    ...
    TIER_LOW =
    {"abra","amaura","anorith","applin","archen","arrokuda","axew","azurill",
     "baltoy","bagon","barboach","bayleef","beldum","bellsprout","bidoof","bonsly","bounsweet","bronzor","budew","buizel","buneary","burmy",
     "cacnea","carvanha","cascoon","caterpie","charcadet","cherubi","chinchou","chingling","clamperl","clauncher","cleffa","clobbopus","combee","corphish","cottonee","cranidos","cubchoo","cutiefly",
     ...
     "feebas","fennekin","ferroseed","fidough","finneon","flabebe","fomantis","foongus","fuecoco",
     ...
     "machop","magby","magikarp","magnemite","makuhita","mankey","mantyke","mareanie","mareep","meditite","metapod","mienfoo","mime_jr","minccino","morelull","mudbray","munna","murkrow",
     "natu","nickit","nincada","noibat","nosepass","numel","nymble",
     "oddish","omanyte","onix",
     "pansear","paras","patrat","pawmi","pawniard","petilil","phantump","pidgey","pidove","pineco","poliwag","ponyta","poochyena","popplio","porygon","psyduck","pumpkaboo","purrloin",
     "quaxly",
     "ralts","rattata","remoraid","rhyhorn","roggenrola",
     "salandit","sandile","sandshrew","sandygast","scraggy","seedot","seel","sentret","sewaddle","shellder","shellos","shieldon","shinx","shroomish","shuppet","silcoon","sinistea","skorupi","slakoth","slowpoke","slugma","smoochum","sneasel","snom","snorunt","snover","snubbull","sobble","solosis","spearow","spheal","spinarak","spoink","sprigatito","spritzee","starly","staryu","stufful","stunky","sunkern","surskit","swablu","swinub","swirlix",
     "teddiursa","tentacool","tinkatink","togepi","trapinch","trubbish","tympole","tyrogue",
